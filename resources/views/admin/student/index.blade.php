                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                   <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <button class="btn btn-danger add-btn" href="{{ $create_link }}" id="add_btn"><i class="ri-add-line align-bottom me-1"></i> Create {{ $title }}</button>
